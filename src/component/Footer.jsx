    ...
    <footer className="bg-[#111111] text-[#EAE6DF] pt-20 pb-10 border-t border-[#222222]">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 py-16 border-b border-[#222222]">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="hover:text-[#D4AF37] transition-colors" aria-label="Instagram">
                <svg className="w-4 h-4 fill-current text-white hover:text-[#D4AF37] transition-colors" viewBox="0 0 24 24">
              ...
              {/* TikTok SVG */}
              <a href="#" className="text-white hover:text-[#D4AF37] transition-colors" aria-label="TikTok">
                <svg className="w-4 h-4 fill-current text-white hover:text-[#D4AF37] transition-colors" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 1 1-5.2-1.74 2.89 2.89 0 0 1 2.31-2.82V7.63a6.34 6.34 0 1 0 6.34 6.34V9.4a8.16 8.16 0 0 0 4.77 1.52V7.46a4.85 4.85 0 0 1-1-.77z" />
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            <h4 className="text-xs uppercase font-semibold tracking-[0.25em] text-white mb-6">
              Quick Links
            </h4>
          ...
          {/* Column 4: CONTACT US */}
          <div>
            <h4 className="text-xs uppercase font-semibold tracking-[0.25em] text-white mb-6">Contact Us </h4>
            <ul className="space-y-3 text-xs tracking-wider text-gray-400 font-serif">
